      ...
      <Layout style={{ minHeight: "100vh" }}>
        ...
        <Layout style={{ margin: "5%" }}>
          <Content>
            ...
            <CustomDescriptionBox
              msg={
                "In quantum mechanics, particles like electrons can sometimes 'tunnel' through potential energy barriers that they would not be able to overcome in classical physics. This means that the particle has a probability of passing through the barrier rather than bouncing off it, and the likelihood of this happening increases as the barrier becomes thinner and weaker. In addition, particles with higher kinetic energy tend to tunnel more often. This phenomenon is due to the wave-like nature of particles at the quantum scale, which allows them to 'borrow' energy to pass through barriers that would be insurmountable for classical particles. Try changing the width and intensity of the barrier as well as the energy of the particle. Does the particle always tunnel? What shape does the probability density function take once it meets the wall? How does it relate to the shape of the probability function as it is propagating?"
              }
            />
          </Content>
        </Layout>
