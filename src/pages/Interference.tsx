...
const Interference = () => {
  ...
  async function handleSubmit(event: any) {
    ...
    let base_url = "https://us-central1-quantum-model-generator.cloudfunctions.net/interference"
    let final_url =
    base_url + "?spacing=" + spacing_str + "&sep=" + slit_separation + "&momentum=" + wave_str;
