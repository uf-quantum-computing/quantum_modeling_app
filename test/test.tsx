      ...
      <Layout style={{ minHeight: "100vh" }}>
        ...
        <Layout style={{ margin: "5%" }}>
          <Content>
            ...
            {/*  </Grid>*/}
            {/*</Grid>*/}
            {/* Conditional rendering based on whether animationJsHtml is available */}
            {animationJsHtml ? (
              <div dangerouslySetInnerHTML={{ __html: animationJsHtml }} />
            ) : (
              // Placeholder or loading indicator when animationJsHtml is empty or being fetched
              <CircularProgress />
            )}
            <CustomDescriptionBox
              msg={
